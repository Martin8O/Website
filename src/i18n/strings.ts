...
export const STRINGS: Record<Lang, UiStrings> = {
  en: {
    ...
    workClaudeSub: '· five real apps in ~a month — then [[this site in 4 days]], its 3D version in 6 more',
    ...
    changelog: 'Changelog',
    changelogBody: 'How this site was built, straight from its GitHub history:',
  ...
  cs: {
    ...
    workClaudeSub: '· pět skutečných aplikací za ~měsíc – a pak [[tento web za 4 dny]], jeho 3D verze za dalších 6 dní',
    ...
    changelog: 'Changelog',
    changelogBody: 'Jak tenhle web vznikal – přímo podle jeho historie na GitHubu:',
